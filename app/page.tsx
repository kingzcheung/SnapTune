    ...
    <div className="h-full relative">
      {files.length > 0 ? (
        ...
        <div className="h-full pb-4 px-4">
          <Button
            className="w-full h-full group transition-all ease-in-out flex flex-col bg-zinc-300/20 border-2 p-8 border-dashed border-zinc-400 hover:border-blue-600"
